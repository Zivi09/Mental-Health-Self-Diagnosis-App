...
class MentalHealthDiagnosisApp:
    def __init__(self, master):
        ...
        self.bg_image = tk.PhotoImage(file="mental_health.2.png")
    ...
    def mental_fitness(self):
        ...
        left_label = tk.Label(left_frame, text="Left Box", font=("Arial", 20, "bold"))
        left_label.pack(pady=10)

        left_text_label = tk.Label(left_frame, text="Initial information", font=font_style, wraplength=600, justify="left")
        left_text_label.pack(pady=10)

        # Combobox
        combobox_values = ["Option 1", "Option 2", "Option 3"]
        combobox = ttk.Combobox(mental_fitness_window, values=combobox_values, font=font_style)
    ...
    def about(self):
        ...
        # Use relative path and handle image reference to prevent garbage collection
        img = Image.open("mental_health.1.png")
        img = ImageTk.PhotoImage(img)
        about_window.img = img  # Keep reference
        ...
        # Title
        title_label = tk.Label(inner_frame, text="Know About MHSDT", bg="#f0f0f0", font=("Arial", 20, "bold"))
        ...
        about_label = tk.Label(inner_frame, text=about_text, bg="#f0f0f0", font=("Arial", 14), wraplength=500, justify="center")
        ...
        disclaimer_label = tk.Label(inner_frame, text=disclaimer_text, bg="#f0f0f0", font=("Arial", 14, "bold"), wraplength=500, justify="center")
        disclaimer_label.pack(pady=10)

        canvas.create_window((0, 0), window=inner_frame, anchor="nw")

        # button to go back to the registration page
        back_button = tk.Button(about_window, text="Back to Registration", command=about_window.destroy, bg="#007bff", fg="white", font=("Arial", 14), padx=10, pady=5)
    ...
    def reach_out_to_us(self):
        ...
        self.contact_window.geometry("500x600")

        font_style = ("Arial", 18)

        # Support Email/Phone
        support_label = tk.Label(self.contact_window, text="For support, please contact us at:", font=font_style)
        support_label.pack(pady=10)

        support_info_label = tk.Label(self.contact_window, text="support@example.com\nPhone: 123-456-7890", font=font_style)
        support_info_label.pack(pady=10)

        # Feedback Form
        feedback_label = tk.Label(self.contact_window, text="Have feedback or suggestions? Let us know!", font=font_style)
        feedback_label.pack(pady=10)

        feedback_button = tk.Button(self.contact_window, text="Provide Feedback", command=self.open_feedback_form, font=font_style)
        feedback_button.pack(pady=10)

        # FAQ Section
        faq_label = tk.Label(self.contact_window, text="Questions? Check out our FAQ section:", font=font_style)
        faq_label.pack(pady=10)

        faq_button = tk.Button(self.contact_window, text="FAQ", command=self.open_faq, font=font_style)
        faq_button.pack(pady=10)

        # Privacy Policy and Terms
        policy_label = tk.Label(self.contact_window, text="Read our Privacy Policy and Terms of Service:", font=font_style)
        policy_label.pack(pady=10)

        policy_button = tk.Button(self.contact_window, text="Privacy Policy", command=self.open_privacy_policy, font=font_style)
        policy_button.pack(pady=10)

        # Social Media Links
        social_label = tk.Label(self.contact_window, text="Connect with us on social media:", font=font_style)
        social_label.pack(pady=10)

        social_buttons_frame = tk.Frame(self.contact_window)
        social_buttons_frame.pack(pady=10)

        facebook_button = tk.Button(social_buttons_frame, text="Facebook", command=self.open_facebook, font=font_style)
        facebook_button.pack(side="left", padx=10)

        twitter_button = tk.Button(social_buttons_frame, text="Twitter", command=self.open_twitter, font=font_style)
        twitter_button.pack(side="left", padx=10)

    def open_faq(self):
        messagebox.showinfo("FAQ", "Frequently Asked Questions feature is coming soon!")

    def open_privacy_policy(self):
        messagebox.showinfo("Privacy Policy", "Privacy Policy & Terms of Service will be available soon.")

    def open_facebook(self):
        messagebox.showinfo("Social Media", "Connecting to Facebook...")

    def open_twitter(self):
        messagebox.showinfo("Social Media", "Connecting to Twitter...")
...
##        self.second_window= tk.PhotoImage(file="mental_health.3.png")
##        # Create a Label widget to display the background image
